 ...
 const state = {
    ...
    races: [
        ...
        },
        {
            ...
            description: [
                'Mágikus beavatkozás eredménye képpen létrejött faj, melynek egyedei az orkok legértékesebb tulajdonságait csillogtatják: a makacsságig menő kitartást, a természetes, állati inteligenciát, a kérhetetlen vadságot - ezúttal az emberiség céljai érdekében.',
                'Az udvari - másnéven nemesitett - orkok Északon jelentek meg, első osztaguk egy ottani hatalmasság szolgálatában állt. A világhir, azaz inkább a koronás fők divathóbortja akkor kapta szárnyára őket, mikor kemény küzdelemben megmentették a szorongatott nagyúr életét.',
