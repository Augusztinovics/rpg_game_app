    ...
    <div>
        <div class="container-md border border-secondary p-2 mt-4">
            ...
            <div class="text-center m-3">
                <h1>{{ gameSeen.module_data.title }}</h1>
            </div>
            ...
            <div class="text-center">
                <div class="stage-des">
                    ...
                    <div class="stage-des-text">
                        <p class="stage-text"><b>{{ gameSeen.module_data.description }}</b></p>
                    </div>
                </div>
            </div>
        </div>
        <!-- Jegyzetek -->
        <div v-if="isGm" class="accordion" id="'accordionNote'">
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNote" aria-expanded="false" aria-controls="collapseNote">
                        ...
                        <b class="ms-4">A jelenet egyzetei ( csak a KM láthassa )</b>
                    </button>
                </h2>
                <div id="collapseNote" class="accordion-collapse collapse" aria-labelledby="heading" data-bs-parent="#accordionNote">
                    <div class="accordion-body">
                        <p v-for="note, index in gameSeen.module_data.note" :key="'NOTE' + index" class="d-flex justify-content-between border border-secondary p-2">{{ note }}</p>
                    </div>
                </div>
            </div>
        </div>
