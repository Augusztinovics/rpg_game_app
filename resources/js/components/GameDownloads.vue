<template>
    <div class="container-fluid">
        <ul
            class="nav nav-pills mb-3 border border-success rounded p-3"
            id="pills-tab"
            role="tablist"
        >
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            >
               <div class="text-center m-3">
                   <img class="me-5" src="/img/pentagram.png" alt="pentagram" width="50" height="50">
                   <a href="public/magus-character-sheet" class="btn btn-link">
                    ...
                    <img class="ms-5" src="/img/pentagram.png" alt="pentagram" width="50" height="50">
               </div>
               <hr>
               <div>
