...
Route::get('admin/game-site-view-data', [AdminController::class, 'getGameSiteViewData']);
...
Route::post('site/game-module/update-state/{module}', [GameSiteController::class, 'updateGameModuleState']);
Route::get('site/game-module-data/{id}', [GameSiteController::class, 'getNewModuleData']);
